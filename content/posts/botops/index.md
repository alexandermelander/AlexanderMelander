...
The biggest thing I'm missing from this is implementing the navmesh regions that I have generated into the AI's behaviour. They're already there, but right now our enemies are sampling the entire Navmesh, and while it's not super large, it would be impossible to scale this without seeing significant reduction of performance. Ultimately for this small 10-mintue experience it works due to our distance culling of the enemies. They will never sample enough nodes to cause performance issues because if they are too far away, they will be removed and added back into the enemy pool for the wave.